                        ...
                        <table class="table" id="salesTable">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Shift Start Dtae</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-warning btn-sm rounded-pill edit-btn"
                                            data-toggle="modal" data-target="#editSaleModal"
                                            data-id="{{ $sale->id }}"><i class="fa-regular fa-pen-to-square"></i></button>
            ...
            button.addEventListener('click', function() {
                ...
                fetch(`/sales/${saleId}/edit`)
                    ...
                    .then(data => {
                        ...
                        editForm.querySelector('[name="dept_id"]').value = data.dept_id;
                        editForm.querySelector('[name="amount"]').value = data.amount;
    
                        // Update the form action URL to include the sale ID
